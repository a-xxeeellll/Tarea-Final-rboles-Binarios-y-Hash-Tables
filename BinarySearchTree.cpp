...
void DemostracionBinarySearchTree()
{
	...
	// ----------------- AGREGADOS PARA LOS PUNTOS DEL EJERCICIO -----------------

	// Punto 4: Post-order iterativo (mismo formato de salida que el recursivo)
	myBST.PostOrderIterativo();

	// Punto 2: Search iterativa
	bool existe3 = myBST.Search(3);
	cout << "Search(3) iterativa -> " << (existe3 ? "true" : "false") << endl;

	bool existe10 = myBST.Search(10);
	cout << "Search(10) iterativa -> " << (existe10 ? "true" : "false") << endl;

	// Punto 3: Viaja izq, viaja der y borra el nodo (postorden + borrar)
	myBST.ClearPostOrderIterative();
	cout << "Arbol limpiado con ClearPostOrderIterative()." << endl;
